...
/// Sticky header for the character details page with title and favourite action
class CharacterStickyHeader extends StatelessWidget {
  ...
  /// Whether the character is marked as favourite
  ...
  /// Creates a character sticky header
  const CharacterStickyHeader({
    super.key,
