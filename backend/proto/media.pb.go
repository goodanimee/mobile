...
type Media struct {
	...
	SeasonYear        *int32                    `protobuf:"varint,27,opt,name=season_year,json=seasonYear,proto3,oneof" json:"season_year,omitempty"`
...
const file_media_proto_rawDesc = "" +
	"\n" +
	"\vmedia.proto\x12\tgoodanime\x1a\x15media_character.proto\x1a\x10media_edge.proto\x1a\x16media_list_entry.proto\x1a\x0fmedia_min.proto\x1a\x10media_misc.proto\x1a\x1amedia_recommendation.proto\x1a\x12media_review.proto\x1a\x11media_staff.proto\x1a\x12media_studio.proto\x1a\x11media_trend.proto\"\x8a\n" +
	"\n" +
	"\x05Media\x12'\n" +
	...
	"\areviews\x18\x1a \x01(\v2\x1b.goodanime.ReviewConnectionR\areviews\x12$\n" +
	"\vseason_year\x18\x1b \x01(\x05H\x02R\n" +
	"seasonYear\x88\x01\x01B\r\n" +
	"\v_mean_scoreB\r\n" +
	"\v_favouritesB\x0e\n" +
